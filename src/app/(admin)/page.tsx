      ...
      <div className="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div className="col-span-12 md:col-span-4">
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
            ...
            <CardDescription>
              Gerencie as empresas que fazem parte do seu sistema.
            </CardDescription>
            <Link
              href="/empresas"
              className="inline-flex items-center gap-1 mt-4 text-sm text-brand-500 hover:text-brand-600"
        ...
        <div className="col-span-12 md:col-span-4">
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
            ...
            <CardDescription>
              Visualize e gerencie os contatos disponíveis.
            </CardDescription>
            <Link
              href="/contatos"
              className="inline-flex items-center gap-1 mt-4 text-sm text-brand-500 hover:text-brand-600"
        ...
        {/* Linha 2: Card maior para Negociações */}
        <div className="col-span-12">
          <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
            <CardTitle>Negociações</CardTitle>
            <CardDescription>
              Gerencie suas negociações de forma rápida e intuitiva.
            </CardDescription>
            <Link
              href="/negociacoes"
              className="inline-flex items-center gap-1 mt-4 text-sm text-brand-500 hover:text-brand-600"
