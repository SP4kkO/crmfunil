      ...
      <div className="sm:h-[calc(100vh-174px)] xl:h-[calc(100vh-186px)]">
        <div className="flex flex-col gap-6 xl:h-full sm:gap-5 xl:flex-row">
          ...
          <div className="flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] xl:h-full xl:w-4/5">
            <EmailDetailsHeader />
            <div className="block p-5 overflow-y-auto xl:min-h-screen custom-scrollbar xl:p-6">
              ...
              <div className="text-sm text-gray-500 mb-7 dark:text-gray-400">
                ...
                <p className="mb-4">
                  ...
                  consectetur. Nam vestibulum eleifend magna quis porta. ipsum
                  dolor sit amet, consectetur adipiscing elit. Praesent ut
                  rutrum mi. Aenean ac leo
                </p>
                ...
                <p className="mb-4">
                  ...
                  Nulla a rhoncus lectus. In nunc neque, pellentesque non massa
                  ornare, accumsan ornare massa. odales diam, quis rhoncus dolor
                  aliquet a. Nulla a rhoncus lectus. In nunc neque
                </p>

                <p className="mb-4">
                  Suspendisse semper vel turpis vitae aliquam. Aenean semper dui
                  in consequat ullamcorper.
                </p>

                <p className="mb-4">
                  Nullam tincidunt sodales diam, quis rhoncus dolor aliquet a.
                  Nulla a rhoncus lectus. In nunc neque, pellentesque non massa
                  ornare, accumsan ornare massa. sodales diam, quis rhoncus
                  dolor aliquet a. Nulla a rhoncus lectus. In nunc neque
                </p>
