...
// Definição da interface de Empresa conforme o retorno de API
interface Empresa {
  id: number;
  nome: string;
  segmento?: string;
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {currentItems.map((company) => (
                ...
                >
                  ...
                  <TableCell className="px-4 py-4">{company.segmento || "-"}</TableCell>
                  <TableCell className="px-4 py-4">{company.cidade || "-"}</TableCell>
                  <TableCell className="px-4 py-4">{company.estado || "-"}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
